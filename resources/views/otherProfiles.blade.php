            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-center mt-4">
                ...
                <div class="text-center sm:text-right">
                    <button id="followBtn" onclick="follow()"
                        class="px-4 py-2 bg-[#7494ec] text-white rounded-lg hover:bg-[#7494ec] transition">
                        @if ($apakahFollow)
                            Unfollow
                        @else
                            Follow
                            ...
                            <div class="flex flex-col sm:flex-row items-start border-b border-[#7494ec] pb-4 mb-4">
                                <div class="flex-1 mt-4 sm:mt-0 sm:ml-4">
                                    ...
                                    <div class="flex mt-3 items-center">
                                        <button
                                            class="px-3 py-1 bg-[#7494ec] text-white rounded-lg hover:bg-[#7494ec] transition mr-3">
                                            Like
                                        </button>
        ...
        async function follow() {
            try {
                ...
                if (data.ok) {
                    ...
                    if (data.data.user.following && data.data.user.following.length > 0) {
                        const email = user['email'];
                        isFollowing = data.data.user.following.some(follower => follower.email === email);
                    }
