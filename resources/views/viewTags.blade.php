            ...
            $tags = [
              [
                ...
                [
                    ...
                    'description' => 'Python is a high-level, interpreted language with a focus on readability and simplicity.'
                ],
                [
                    'name' => 'java',
                    'questions' => 1922458,
                    'asked_today' => 52,
                    'asked_this_week' => 506,
                    'description' => 'Java is known for its "Write Once, Run Anywhere" capability and is widely used in enterprise applications.'
                ],
                [
                    'name' => 'c#',
                    'questions' => 1625547,
                    'asked_today' => 56,
                    'asked_this_week' => 453,
                    'description' => 'C# is used for developing Windows applications, web services, and games using the .NET framework.'
                ],
                [
                    'name' => 'php',
                    'questions' => 1469534,
                    'asked_today' => 24,
                    'asked_this_week' => 246,
                    'description' => 'PHP is commonly used in server-side web development and powers a large number of websites.'
                ],
                [
                    'name' => 'android',
                    'questions' => 1421767,
                    'asked_today' => 41,
                    'asked_this_week' => 379,
                    'description' => 'Android powers a vast number of smartphones and tablets, offering a rich app ecosystem.'
                ],
                [
                    'name' => 'html',
                ...
                [
                    ...
                    'asked_today' => 5,
                    'asked_this_week' => 38,
                    'description' => 'jQuery simplifies JavaScript programming by providing easy-to-use functions for HTML document manipulation.'
                ],
            ];
        @endphp
        ...
        @foreach ($tags as $index => $tag)
            <div class="bg-white shadow-md rounded-lg p-4 border-b-4 border-l-4 border-b-[--purple] border-l-[--bblue]">
                ...
                <h3 class="text-lg font-semibold text-[--purple] capitalize text-center">{{ $tag['name'] }}</h3>
                    ...
                    <span 
                        class="material-symbols-outlined text-[--purple] text-2xl cursor-pointer toggle-btn"
