                ...
                <div class="border-b-2 py-4 flex flex-col lg:flex-row">
                    <div class="me-5 mx-1">
                        ...
                        <div class="mt-3 flex flex-wrap space-x-3">
                            ...
                            <div class="p-0 font-semibold inline-flex items-center cursor-auto">
                        <i class="text-sm mx-1 fa-solid fa-eye bg-transparent text-gray-500 focus-visible:text-blue-500"></i>
                        <span class="text-gray-900 text-xs">{{ $question['view'] }}</span>
                    </div>
                            <div class="p-0 font-semibold inline-flex items-center cursor-auto">
                        <i class="text-sm mx-1 fa-regular fa-comment bg-transparent text-gray-500 focus-visible:text-blue-500"></i>
